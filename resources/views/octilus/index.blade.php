                     ...
                     <form action="{{ 'save1'}}">
                        <div id="slide01">
                           ...
                           <div class="mb-3 text-start">
                              ...
                              <input type="text" class="form-control" id="FormControlInput1" name="name" placeholder="First Name">
                           </div>
                           <div class="mb-3 text-start">
                              <label for="FormControlInput2" class="form-label">Last Name</label>
                              <input type="text" class="form-control" id="FormControlInput2" name="name2" placeholder="Last Name">
                           </div>
                           <div class="mb-3 text-start">
                              ...
                              <fieldset>
                                 ...
                                 <div class="row">
                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 ">
                                       <select name="lstDobDay" id="lstDobDay" class="form-control watermark" name="date_of_birth">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 ">
                                       <select name="lstDobMonth" id="lstDobMonth" class="form-control watermark" name="date_of_birth">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12">
                                       <select name="lstDobYear" id="lstDobYear" class="form-control" name="date_of_birth">
                        ...
                        <div id="slide02" style="display:none;">
                           ...
                           <div class="mb-3 text-start">
                              ...
                              <input type="email" class="form-control" id="FormControlInput4" placeholder="Email Address" name="email">
                           </div>
                           <div class="mb-3 text-start">
                              <label for="FormControlInput5" class="form-label">Phone Number</label>
                              <input type="text" class="form-control" id="FormControlInput5" placeholder="Phone Number" name="phone">
                           </div>
                           <div class="mb-3 text-center">
